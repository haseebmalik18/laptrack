...
async function GET(request) {
    try {
        ...
        const insights = [
            {
                corner: 3,
                distance: corners.find((c)=>c.cornerNumber === 3)?.apexDistance || 704,
                brakingDistance: corners.find((c)=>c.cornerNumber === 3)?.brakingZone?.entryDistance || 679,
                type: 'braking',
                title: 'Brake Later',
            ...
            {
                corner: 5,
                distance: corners.find((c)=>c.cornerNumber === 5)?.apexDistance || 1486,
                brakingDistance: corners.find((c)=>c.cornerNumber === 5)?.brakingZone?.entryDistance || 1455,
                type: 'exit',
            ...
            {
                corner: 8,
                distance: corners.find((c)=>c.cornerNumber === 8)?.apexDistance || 1991,
                brakingDistance: corners.find((c)=>c.cornerNumber === 8)?.brakingZone?.entryDistance || 1914,
                type: 'braking',
                title: 'Way Too Slow',
            ...
            {
                corner: 12,
                distance: corners.find((c)=>c.cornerNumber === 12)?.apexDistance || 3562,
                brakingDistance: corners.find((c)=>c.cornerNumber === 12)?.brakingZone?.entryDistance || 3427,
                type: 'apex',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2be8499f._.js.map