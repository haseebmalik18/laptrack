    ...
    try {
        ...
        try {
            if (lapInfoA) {
                ...
                metadataA = JSON.parse(__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(metadataPath, 'utf-8'));
            }
            if (lapInfoB) {
                const metadataPath = lapInfoB.filePath.replace('.csv', '.json');
                metadataB = JSON.parse(__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(metadataPath, 'utf-8'));
            }
        } catch (err) {
        ...
        // Get track name
        const trackName = metadataA.trackName || 'bahrain';
        const match = trackName.match(/\(([^)]+)\)/);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f0ab521e._.js.map