...
async function GET() {
    ...
    if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(lapsDir)) {
    ...
    const laps = csvFiles.map((file)=>{
        ...
        const jsonPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(lapsDir, jsonFile);
        let metadata = {};
        if (__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(jsonPath)) {
            metadata = JSON.parse(__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(jsonPath, "utf-8"));
        }
        return {
            lapNumber,
            fileName: file,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__18ee8c98._.js.map