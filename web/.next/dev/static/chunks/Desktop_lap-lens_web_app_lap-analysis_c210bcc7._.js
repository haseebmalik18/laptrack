    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$lap$2d$lens$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TrackMap2D.useEffect": ()=>{
            ...
            const allX = telemetry.map({
                "TrackMap2D.useEffect.allX": (p)=>p.x
            }["TrackMap2D.useEffect.allX"]);
            const allY = telemetry.map({
                "TrackMap2D.useEffect.allY": (p)=>p.y
            ...
            const toScreenY = {
                "TrackMap2D.useEffect.toScreenY": (y)=>height - (padding + (y - minY) * scale)
            ...
            const maxSpeed = Math.max(...telemetry.map({
...
_s(ReplayScrubber, "hLT25hqZAGML0DYw4UQjGA/zCTE=");
_c = ReplayScrubber;
var _c;
...
//# sourceMappingURL=Desktop_lap-lens_web_app_lap-analysis_c210bcc7._.js.map